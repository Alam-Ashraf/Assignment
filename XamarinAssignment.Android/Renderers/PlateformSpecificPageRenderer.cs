...
[assembly: ExportRenderer(typeof(PlateformSpecificPage), typeof(PlateformSpecificPageRenderer))]
namespace XamarinAssignment.Droid.Renderers
{
    public class PlateformSpecificPageRenderer : PageRenderer, TextureView.ISurfaceTextureListener
    {
        ...
        public PlateformSpecificPageRenderer(Context context) : base(context)
        {
        }
